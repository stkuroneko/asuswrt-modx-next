...
#ifndef __MT7612_EZ_chip_ops_api_H__
#define __MT7612_EZ_chip_ops_api_H__

#ifdef WH_EZ_SETUP

extern UCHAR IPV4TYPE[];

unsigned char ez_driver_ops_RandomByte_mt7612(void *ezdev);
...
MAC_TABLE_ENTRY *MacTableLookup2(PRTMP_ADAPTER pAd, UCHAR *pAddr, struct wifi_dev *wdev);
VOID APScanCnclAction(PRTMP_ADAPTER pAd, PMLME_QUEUE_ELEM Elem);
