...
extern ez_driver_ops_t ez_driver_ops_7612;
...
extern BOOLEAN ez_apcli_rx_grp_pkt_drop_hook(ez_dev_t *ezdev, struct sk_buff *pSkb);
...
void ez_allocate_or_update_non_ez_band_hook(void *wdev,
	void *ad, UINT32 ezdev_type, CHAR func_idx, non_ez_driver_ops_t *driver_ops,
	UCHAR *channel);
