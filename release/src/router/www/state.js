			...
			for(var i=0; i<menuList.length; i++){
				...
				if(curMenu.index === "menu_Split"){
					...
					if(curMenu.tab[firstEntry].url !== "NULL"){
						...
						if((based_modelid == "RT-AC85U" || based_modelid == "RT-AC85P" || based_modelid == "RT-MIR3P" || based_modelid == "RM-AC2100" || based_modelid == "R6800") && curMenu.index == 'menu_QoS')	//MODELDEP : RT-AC85U change icon
...
function refreshStatus(xhr){
	...
	if(bwdpi_support && qos_enable_flag && qos_type_flag == "1"){
		...
		if(based_modelid == "RT-AC85U" || based_modelid == "RT-AC85P" || based_modelid == "RT-MIR3P" || based_modelid == "RT-AC68A" || based_modelid == "RT-AC65U" || based_modelid == "R6800" || based_modelid == "RM-AC2100"){	//MODELDEP : Spec special fine tune
