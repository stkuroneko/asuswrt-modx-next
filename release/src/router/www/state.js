...
function show_banner(L3){// L3 = The third Level of Menu
	...
	if(rog_support){
		...
		banner_code +='<div class="banner1" align="center"><img src="images/New_ui/swrt.png" width="218" height="54" align="left">\n';
			...
			for(var i=0; i<menuList.length; i++){
				...
				if(curMenu.index === "menu_Split"){
					...
					if(curMenu.tab[firstEntry].url !== "NULL"){
						...
						if((based_modelid == "RT-AC85U" || based_modelid == "RT-AC85P" || based_modelid == "RT-MIR3P" || based_modelid == "RT-A040WQ" || based_modelid == "RT-MSG1500" || based_modelid == "RM-AC2100" || based_modelid == "R6800") && curMenu.index == 'menu_QoS')	//MODELDEP : RT-AC85U change icon
...
function refreshStatus(xhr){
	...
	if(bwdpi_support && qos_enable_flag && qos_type_flag == "1"){
		...
		if(based_modelid == "RT-AC85U" || based_modelid == "RT-AC85P" || based_modelid == "RT-MIR3P" || based_modelid == "RT-A040WQ" || based_modelid == "RT-MSG1500" || based_modelid == "RT-AC68A" || based_modelid == "RT-AC65U" || based_modelid == "R6800" || based_modelid == "RM-AC2100"){	//MODELDEP : Spec special fine tune
