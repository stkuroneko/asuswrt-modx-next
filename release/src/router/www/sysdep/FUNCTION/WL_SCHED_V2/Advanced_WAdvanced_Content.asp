...
function initial(){
	...
	if(wl_unit_value == '1' || wl_unit_value == '2'){ // 5GHz up
		...
		if(based_modelid == "RT-AC66U" || based_modelid == "RT-AC85U" || based_modelid == "RT-AC65U" || based_modelid == "RT-AC85P" || based_modelid == "RT-MIR3P" || based_modelid == "RT-ACRH26" || based_modelid == "RT-AC1200_V2" || based_modelid == "RT-ACRH18" || based_modelid == "RT-AC2100" || based_modelid == "RT-MIR3G" || based_modelid == "R6800"){
			document.getElementById('wl_txbf_desc').innerHTML = "<#WLANConfig11b_x_acBeam#>";
			inputCtrl(document.form.wl_txbf, 1);	
		}
	...
	if(bcm_mumimo_support){
		...
		else if((based_modelid == "RT-AC85U" || based_modelid == "RT-AC85P" || based_modelid == "RT-MIR3P" || based_modelid == "RT-ACRH26" || based_modelid == "RT-AC65U" || based_modelid == "RT-ACRH18" || based_modelid == "4G-AC86U" || based_modelid == "4G-AX56" || based_modelid == "RT-AC2100" || based_modelid == "RT-MIR3G" || based_modelid == "R6800") && wl_unit_value == '0'){
			document.getElementById("wl_MU_MIMO_field").style.display = "none";
		}
