...
#if defined(JCGQ10PRO) || defined(H3CTX1801) || defined(PGBM1) || defined(XMCR660X) || defined(RTCMCCA9)|| defined(RTQ20)|| defined(RTTX1801)|| defined(RTAX53U)|| defined(RTHAR)|| defined(RTCR660X) || defined(JCGQ20)
